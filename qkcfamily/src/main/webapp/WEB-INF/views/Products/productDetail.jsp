...
<body>
  ...
  <nav class="navbar">
            <div class="navbar-logo">
                <a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/resources/imgs/logo.png" alt="회사 로고" ></a>
            </div>
            ...
            <div class="navbar-search">
                <form action="${pageContext.request.contextPath}/Common/HeadSearch" method="POST">
                    ...
                    <button type="submit">
                        <img src="${pageContext.request.contextPath}/resources/imgs/search-img.png" alt="돋보기" style="width: 30px; height: 30px;">
                    </button>
                </form>
            </div>
