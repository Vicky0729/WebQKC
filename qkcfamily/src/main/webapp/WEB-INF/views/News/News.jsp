...
<body>
	...
	<section id="newsMain">
		...
		<article class="wrap introWrap">
			...
			<img alt="뉴스" src=""> <br> <br>
			<div class="bxComTit">
				<p class="tit">
					주식회사 동서는 공정하고 투명한 거래를 원칙으로 <br>
					<strong>인간중심을 통해 미래가치를 창출, 사회에 공헌</strong>하는 <br>세계적인 종합 식품회사를
					추구합니다.
				</p>
				...
				<p class="txt">포장제품 제조업을 기반으로 사업을 시작한 주식회사 동서는 식자재 유통업, 해외 영업,
					구매대행업으로 사업 영역을 확대해, 끊임없는 신제품 개발과 철저한 품질관리, 고객만족을 위한 서비스향상 등으로 안정적인
					성장을 거듭하고 있습니다.</p>
				...
				<p class="txt">주식회사 동서는 외형적인 성장보다는 내실경영을 추구하여 건전한 재무구조와 경영의 투명성을
					실현하고 있습니다. 앞으로도 주식회사 동서는 급변하는 환경 변화에 적극적이고 탄력적으로 대응하고 진취적이고 효율적인
					경영활동을 통해 기업가치를 한층 더 향상시켜 주주 및 고객 여러분과 함께 발전해 나갈 것입니다.</p>
			</div>
		</article>
	</section>
